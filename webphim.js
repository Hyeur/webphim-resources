...
, function(t, e, n) {
    ...
    function _t(t) {
        ...
        u.default)(t, ["store", "computedStyle"]), c = o.element, s = o.actionItem, f = o.immediate, l = o.pluginInstance, d = o.continuous, p = o.restingValue, v = o.eventId, h = !d, E = M(), _ = r.getState(), I = _.ixElements, T = _.ixSession, b = _.ixData, w = L(I, c), O = (I[w] || {}).refState, A = m.getRefType(c), S = T.reducedMotion && g.ReducedMotionTypes[s.actionTypeId];
        if (S && d)
...
, function(t, e, n) {
    ...
    r.define("ix", t.exports = function(t, e) {
        var n, o, a = {}, u = t(window), c = ".w-ix", s = t.tram, f = r.env, l = f(), d = f.chrome && f.chrome < 35, p = "none 0s ease 0s", v = t(), h = {}, E = [], g = [], _ = [], y = 1, m = {
...
, function(t, e, n) {
    var r, i, o, a = n(140), u = n(4), c = n(25), s = n(17), f = n(16), l = n(73), d = n(41), p = u.WeakMap;
    if (a) {
        var v = new p
          , h = v.get
          , E = v.has
...
, function(t, e, n) {
    var r, i = n(195), o = (r = /[^.]+$/.exec(i && i.keys && i.keys.IE_PROTO || "")) ? "Symbol(src)_1." + r : "";
    t.exports = function(t) {
        return !!o && o in t
    }
}
...
, function(t, e, n) {
    var r = n(100)(Object.keys, Object);
    t.exports = r
}
, function(t, e, n) {
...
, function(t, e, n) {
    ...
    function _t(t) {
        ...
        var R, C, N, L = (null !== (e = null == o ? void 0 : null === (n = o.action) || void 0 === n ? void 0 : null === (r = n.config) || void 0 === r ? void 0 : r.affectedElements) && void 0 !== e ? e : {})[T || w] || {}, D = Boolean(L.id || L.selector), P = o && l(gt(o.target));
        ...
        return null == C || null == N ? [] : _.IS_BROWSER_ENV && u ? d(N).filter(function(t) {
            return u.contains(t)
        }) : R === F ? d(C, N) : R === k ? p(d(C)).filter(E(N)) : R === X ? v(d(C)).filter(E(N)) : d(N)
    }
    var yt = /px/
      , mt = function(t, e) {
...
, function(t, e, n) {
    ...
    var r = n(2)
      ...
      , T = function(t, e) {
        ...
        null == g && (E = 1,
        g = c);
        var _, m, I, T, b = Math.max(g, 0) || 0, w = v(b - n), O = l ? d : v(n + w * E), A = 100 * O;
        if (O === n && t.current)
            return t;
        ...
        if (_ && !m)
            ...
            for (var k = (O - I) / T, X = _.config.easing, G = h(X, k, f), V = 0, U = a.length; V < U; V++) {
                var W = a[V]
                  , B = y(s, W, _.config)
      ...
      , b = function(t, e) {
        ...
        if (r && i) {
            ...
            if (O < 0)
                return t;
            var R = v(Math.min(Math.max(0, O / T), 1))
              , C = h(m, R, _)
              , N = {}
              , L = null;
...
, function(t, e, n) {
    var r = n(100)(Object.getPrototypeOf, Object);
    t.exports = r
}
, function(t, e, n) {
    var r = n(98)
        ...
        handler: function(t) {
            ...
            case h.EventBasedOn.PAGE:
                var x = ut()
                  ...
                  , N = x.scrollWidth
                  , L = x.scrollHeight;
                O = b ? Math.min(R + m, N) / N : Math.min(C + T, L) / L;
                break;
...
, function(t, e, n) {
    ...
    i.define("forms", t.exports = function(t, e) {
        ...
        function m(e, n) {
            ...
            _.test(u) ? i.handler = A : u || (o ? i.handler = O : y())
        }
        function I(t) {
...
, function(t, e, n) {
    ...
    r.define("slider", t.exports = function(t, e) {
        var n, u, c, s, f = {}, l = t.tram, d = t(document), p = r.env(), v = ".w-slider", h = '<div class="w-slider-dot" data-wf-ignore />', E = '<div aria-live="off" aria-atomic="true" class="w-slider-aria-label" data-wf-ignore />', g = "w-slider-force-show", _ = i.triggers;
        function y() {
            (n = d.find(v)).length && (n.each(T),
            s = null,
            c || (m(),
            r.resize.on(I),
        ...
        function T(e, n) {
            ...
            i.nav.off(v),
            b(i),
            u ? (i.el.on("setting" + v, N(i)),
            C(i),
            i.hasTimer = !1) : (i.el.on("swipe" + v, N(i)),
        ...
        function D(e, n) {
            ...
            e.nav.children().not(f).removeClass("w-active").attr("aria-pressed", "false").attr("tabindex", "-1"),
            ...
            var d = e.offsetX || 0
              ...
              , b = "opacity " + I + "ms " + m
              , w = "transform " + I + "ms " + m;
            if (h.find(a).removeAttr("tabindex"),
        ...
        function M(e) {
            ...
            function(e) {
                ...
                for (var o = 0, a = e.pages; o < a; o++)
                    (n = t(h)).attr("aria-label", "Show slide " + (o + 1) + " of " + a).attr("aria-pressed", "false").attr("role", "button").attr("tabindex", "-1"),
...
Webflow.require('ix').init([{
    ...
    "slug": "subscie-interactione",
    "name": "Subscie interactione",
    "value": {
        "style": {},
        "triggers": [{
            "type": "click",
...
Webflow.require('ix2').init({
    "events": {
        ...
        "e-3": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "5fe2d564b3fa647670a11cef|630f3a6a-f505-0062-199f-5dbb8e37d22e",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-5": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "5fe2d564b3fa647670a11cef|021743dc-d730-0c7c-38ed-e8456ca0ff0b",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-7": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "5fe2d564b3fa647670a11cef|26a2180a-b98c-0db1-b3a3-f0a6fe4784da",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-9": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "5fe2d564b3fa6483bca11cf8|2e16823f-708b-b9c9-4fc3-f1058f109e2b",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-11": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "5fe2d564b3fa641aeca11cfc|2e8123e6-f997-11ac-0ef0-7a404a0cd2f8",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-13": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "5fe2d564b3fa641aeca11cfc|2e8123e6-f997-11ac-0ef0-7a404a0cd34f",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-15": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "5fe2d564b3fa641aeca11cfc|2e8123e6-f997-11ac-0ef0-7a404a0cd33e",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-17": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "5fe2d564b3fa641aeca11cfc|2e8123e6-f997-11ac-0ef0-7a404a0cd32c",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-19": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "5fe2d564b3fa641aeca11cfc|2e8123e6-f997-11ac-0ef0-7a404a0cd31b",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-21": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "5fe2d564b3fa641aeca11cfc|2e8123e6-f997-11ac-0ef0-7a404a0cd309",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-29": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "5fe2d564b3fa64bb1aa11cf7|fb504413-d5b4-3ca2-7c6c-2e8872f7d460",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
